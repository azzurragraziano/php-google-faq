<?php
    $questions = [
        [
            ...
            'answer' => "La recente decisione della Corte di giustizia dell'Unione europea ha profonde conseguenze per i motori di ricerca in Europa. La Corte ha stabilito che alcuni utenti hanno il diritto di chiedere ai motori di ricerca come Google di rimuovere risultati relativi a chiavi di ricerca che includono il proprio nome.<br><br> Per poter essere rimossi, i risultati visualizzati devono essere inadeguati, irrilevanti o non più rilevanti, o eccessivi.
...
<body>
    ...
    <header>
        ...
        <nav>
            <!-- links list -->
            <ul>
                <?php foreach($headerMenu as $links) { ?>
                    <li>
    ...
    <main>
        <div class="container">
            <?php foreach($questions as $QandA) { ?>
                <div class="question_answer">
                    <h3>
                        <?php echo $QandA['question']; ?>
                    </h3>

                    <p>
                        <?php echo $QandA['answer']; ?>
                    </p>
                </div>
            <?php } ?>
        </div>
